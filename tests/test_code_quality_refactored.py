"""Tests for refactored CodeQualityWorkflow (thin adapter pattern).

These tests verify that the refactored workflow — which wires ScanningPhase,
QualityGate, and ImprovePhase — produces identical external behaviour to the
original monolithic ``run`` method.  They use the same fake-activity pattern
as the existing tests in ``test_code_quality.py``.
"""
...
# ---------------------------------------------------------------------------
# Fake-client for schedule tests
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Cycle 4: verify PhaseOps callback wiring (all 17 fields present)
# ---------------------------------------------------------------------------
